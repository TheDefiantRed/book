...
Starting this review the intention in first instance was to review and describe the existing manufacturing possibilities of the group of cadmium selenium red glazes. Although it is by far the only way which offers so many possibilities for the creation of real red colours in the various area of the ceramic field, it is not the only one.

With the idea in mind to be more complete, it became more and more obvious to also include the other existing methods' contribution towards realizing reddish colours in ceramics. Moreover, the section describing the historical aspects also grew, slowly but surely.

With admiration of what has been explored and described by numerous historians and investigators, I have tried to confine myself to the most relevant literature and available studies. Realization of the long ceramic traditions in various human cultures and their culminating points which were reached over several eras dictates the importance of mentioning these facts, albeit in more general terms.
...
With my sincere thanks to all who helped me to realize this publication.
