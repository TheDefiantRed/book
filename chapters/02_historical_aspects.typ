...
Several sources mention 'kermes' as the oldest recorded dye; a red colour stain obtained from a particular coccus.@lit:methuen-1978[page 184] Also the name scarlet has in this respect a long tradition. It is the colour of the dye cochineal, obtained from a special kind of louse. The word is present in many languages. The origin of the word is explained as being derived from the Persian word 'sakirlat' which indicated clothes dyed with this colour. This can also been said from the Arabic 'sagillat'. The word can also been found in the Latin 'scarlatum', the old-French 'escarlate', the old-German 'scharlach' and the English 'scarlet'.
...
Another organic possibility which was used to obtain a warm red colour came from the roots of the 'Rubia Tinctorum'. This plant was first cultivated in Asia (India, Iran, Egypt), followed by the countries around the Mediterranean. From the 16th century, the plant was also cultivated on a rather large scale in France and The Netherlands (mainly the south-west part). The dried and pulverized roots were used for colouring wool and silk.@lit:dr-j-m The important component here is alizarine (from the Arab word 'al oesara' = the sap). The chemical compound responsible for the colouring is 1,2-dihydroxyanthraquinone (#ch("C14H8O4")). This compound is intrinsically light coloured. When chemically bound with metal oxides (#ch("Al"), #ch("Zn")) the real vivid red colours become possible to produce. Similarly, clear red colours could be created (figures 3 and 4).
...
Although science cannot give an exact time or place were a society started to use clay as building material or for food storing, there are some historical clues that one of the oldest and common ceramic industries existed in the Near East countries. This dated back some 7000 to 8000 years.@lit:robert-j-charleston Even before this time it was already known how to make use of the plastic properties of clay. Many human and animal figures are found at several human civilizations around the world. As one example of the existence of a kind of pottery culture at a completely different place, the so-called band-ceramic culture can be mentioned. Under the leadership of prof. dr. P.J.R. Modderman excavation and a study were made from 1950 till 1966 in Elsloo, a small village in the Dutch province Limburg. In that place an ancient settlement was found. With the active carbon method the settlement could be dated as from 4400 till 4000 BC.@lit:prof-dr-p The ceramic articles which were found were rather simple, except the decoration. The decoration in the form of engraved bands around the upper part of the pots and vases is so typical that it has given the name to the inhabitants of these settlements. The decoration of the oldest pieces was rather simple; the latest vases show a very nice game of lines and points in wavy movements around the vases. These types of settlements of the so-called 'band ceramic people' are found in central Europe along the Danube countries and in western directions following more or less the river Rhine till the south-eastern part of what now is Belgium and The Netherlands.@lit:prof-dr-van
...
From the translation of the so-called 'Glassmakers Tablet' which are available, namely one of C. J. Gadd and R. Campbell Thomson@lit:c-j-gadd and another one of A. L. Oppenheim@lit:a-l-oppenheim, it is possible to get a view of the then present knowledge of glass- and glaze techniques.
