...
#recipe[
  #align(center, table(
    ...
    stroke: none,
    align: (left, right),
    [basic frit containing Cd and S], [60 %],
    [supporting frit containing Pb and Cd], [21 %],
...
The development for a more stable glaze formulation was soon focused on the splitting up of the basic frits. From many trials it became clear that the optimum melting conditions for one component (S) worked out very negative for the other component (Cd). Investigations at the various frits learned that the loss of cadmium can easily go up to 80 % due to volatilization during the melting of the frit.#footnote[Report R2915, Chemical Laboratory Ferro (Holland) B.V., 1969.] In case the melting conditions were not optimal the cadmium oxide could rather easily be reduced to cadmium metal which is even more volatile than cadmium oxide.#footnote[F. Ullmann. 'Enzyclopädie der Technischen Chemie', Cadmium und Cadmiumverbindungen. ISBN 3 527 20142 4.] Also the melting temperature had a dramatic effect on the retaining of the cadmium in the frit. Investigations clearly showed that bringing down the melting temperature from 1450 °C to 1350 °C while maintaining the same yield resulted in a 50 % less loss of cadmium oxide in the molten frit. The combination of these two facts and information as e.g. from the German patent 2 023 710 from Hercules Inc. was the start for a study for the development of a new generation of base frits for cadmium yellow and red glazes. The start was made by splitting up the basic (Cd + S) frit for yellow glazes in a frit containing the cadmium and another part containing the sulphur and in such a way that the two frits together matched the same original basic frit again. Next step was to melt the splitted frits under three different melting conditions, viz. oxidizing, neutral and reducing melting conditions. See also @tab:melting-conditions. For the oxidizing conditions the choice was made in the end for the introduction of 2 % sodium nitrate in the raw batch composition. For the reducing conditions a choice was made for melting with less air and with a reducing agent in the batch composition. After testing various possibilities carbon (C) was taken as the reducing agent. Also sugar was tried but was less effective. $"SiC"$ was also tested with good reducing properties but the disadvantage was that it causes contamination of the frit and later contamination of glazes in the mills resulting in pinholes.
...
Testing of the application of carbon as reducing agent learned that a quantity of 2 % was the optimum; 1 % was less effective and more than 2 % didn't render better results. These six frits (see @tab:melting-conditions) were tested again in the standard glaze composition by making combinations of resp. the oxidizing melted Cd frit (i) with the three different molten S frits (iv, v and vi); the neutral melted Cd frit (ii) with the three different molten S frits (iv, v and vi) and the reduced melted Cd frit (iii) with the three different molten S frits (iv, v and vi). The results clearly confirmed that the cadmium frit needed different smelting conditions as the sulphur containing frit. By combining the cadmium frit melted under oxidizing conditions (i) and the sulphur containing frit melted under reducing conditions (vi), the final results were significant better compared to the original yellow glaze formula.
...
It doesn't ask that much imaginative faculty to realise that this method was very much unhealthy and uneconomical due to the volatibility of the selenium metal and also the cadmium compounds. This method was step by step replaced by the wet-chemical precipitation method which was invented by BASF in 1919. By this process the Se metal was dissolved in $"Na"_2"S"$. This solution was added to a cadmium salt solution. A precipitate of cadmium-sulpho-selenide (CdSSe) was the result and this precipitate was washed and dried at the proper temperature. By changing the amounts of resp. cadmium, sulphide and selenium, but also with additions of e.g., zinc oxide or aluminium oxide, one was able to influence the colour tone of the pigment. This wet method replaced the dry method more and more during the 20th century.

Following this process for the wet preparation of CdSSe stains, a method was found in the early 70ties for a better introduction of these components for the selenium frit production. This method was very similar to the method of the wet preparation of CdSSe stains. Basically, the cadmium was replaced by zinc and the following procedure was followed:
...
The resulting precipitate of zinc-sulpho-selenide ($"ZnSSe"$) was centrifuged, dried and later on mixed with quartz in a ratio 1 : 3 for better handling and weighing of the precipitate.
...
Through XR-F analyses a comparison was made between the 'traditional' melted frit and the new developed frit. Results are mentioned in @tab:volatilization-loss.#footnote[Report R2915A, Chemical laboratory Ferro (Holland) B.V., 1969.]
...
Another method for making matt cadmium selenium glazes was the addition of barium carbonate and aluminium oxide in a certain ratio to existing red and yellow glazes as also described in the German patent ref. 2 006 814 from Baykara.#footnote[Erhan Baykara. German patent nr. 2 006 814, 'Verfahren zur Mattierung selenroter und selen-cadmiumroter Glasuren', 1971.]
