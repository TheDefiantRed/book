...
Bigelow and Silverman@lit:m-h-bigelow confirmed the conclusions as found by Rooksby in an investigation published in 1933. They started with following sodium-zinc-silica glasses:
...
The knowledge of the new frits as developed for the yellow frits and glazes was transferred for the development for new basic frits for red frits and glazes. Of course, the cadmium was separated from the basic frits in the first place. The raw material zinc selenite as source for #ch("Se") was changed for the zinc-sulpho-selenide (#ch("ZnSSe")) and the reduction agent carbon was introduced into the raw batch formula. Some other small adaptations were made in the composition but it is mainly the different way of melting which made these types of frits much better with regard to the red colour development and the colour strength.@lit:lw-baaij-basisfritten
...
Through XR-F analyses a comparison was made between the 'traditional' melted frit and the new developed frit. Results are mentioned in @tab:volatilization-loss.@lit:report-r2915a-chemical
...
Another method for making matt cadmium selenium glazes was the addition of barium carbonate and aluminium oxide in a certain ratio to existing red and yellow glazes as also described in the German patent ref. 2 006 814 from Baykara.@lit:erhan-baykara-german
