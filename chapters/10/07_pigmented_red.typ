...
#figure(
  ...
  caption: [Compositions of CdSSe pigments.]
...
#figure(
  table(
    ...
    stroke: none,
    table.hline(stroke: 0.5pt),
    table.header([*Period*], [*CdSSe pigments*], [*CdSSe melted-in glazes*]),
    table.hline(stroke: 0.5pt),
    [19th century], [Production in classical dry way], [Application of Se in glass for rubin red glass and as decolourant.],
...
V. Lambies Lavilla and J. M. Rincón López#footnote[V. Lambies Lavilla; J. M. Rincón López. 'Study of the Mechanism of Formation of a Zircon-Cadmium Sulphoselenide Pigment'. Trans. Journal British Cer. Society, 80, 1981.] gave an explanation with regard to the forming of the $"ZrSiO"_4."Cd"."S"."Se"$ inclusion pigments, mentioning the reactions which take place for the forming of the pigment. They studied mixtures with $"ZrO"_2$, $"SiO"_2$, $"CdS"$, $"CdCO"_3$, S, Se and the mineralisers $"NaF"$ and $"LiF"$. See @tab:compositions-inclusion-pigments for the mixtures. The mixtures were fired at 900 °C in an electrical furnace with a heating rate of 300 °C p/h and 1/2h soaking at top temperature.

Following the article, the authors concluded after investigations with XR-D and SEM analyses that the formation of small crystals of $"ZrSiO"_4$ takes place between $"ZrO"_2$, $"SiO"_2$ and the mineralizer according to the reactions as proposed by Eppler. Simultaneously hexagonal crystals of $"Cd"("S"_x "Se"_(1-x))$ are formed. In the main stage the crystals of $"Cd"("S"_x "Se"_(1-x))$ are trapped by zircon. This phenomenon can be explained in terms of the theory of sintering in the presence of a liquid phase.
...
#figure(
  table(
    ...
    table.hline(stroke: 0.5pt),
    [$"ZrO"_2$], [119], [119], [119], [119],
    [$"SiO"_2$], [58.7], [58.7], [58.7], [58.7],
    [$"CdS"$], [--], [--], [40.5], [40.5],
    [$"CdCO"_3$], [47.5], [47.5], [--], [--],
    [S], [13.4], [13.4], [--], [--],
    [Se], [10], [10], [10], [10],
  ...
  caption: [Compositions of CdSe inclusion pigments.]
...
After the invention of the inclusion pigments and creating the 1st generation of these type of inclusion CdSSe pigments into a zircon silicate crystal, the developments didn't stop and based upon new technologies stronger pigments have been created also by the company Broll Buntpigmente, e.g. red pigment 3033 and others.

Also in the early 80ties some attempts have been made to apply another method to protect the CdSSe stains from an early contact with molten glaze components. This was done with a CVD process (Chemical Vapour Deposition) in cooperation with the Technical University in Eindhoven.#footnote[Corrrespondence between author and Ir. Adriaansen, TU Eindhoven, 1987.] In this process a reactor is used where powder material (like a CdSSe stain) can be brought in a vacuum and at higher temperatures and pressure. Various gasses can be led into the reactor to create a coating around the (powder) material. The tests were done to coat the material among other things with the transparent material $"Si"_3"N"_4$. These first attempts did not give enough positive results for continuation.

Because of the threat of a complete ban on cadmium during the 80ties one was looking for different alternatives. The yellow $"CdS"$ pigment, in the hexagonal crystal lattice, has many proven properties over (organic based) yellow colours. Only a low amount of the pigment is necessary to give a strong yellow colour in plastics (0.4 -- 0.6 %). Also the high temperature resistance during processing of the plastics is a great advantage. The company Colorsil BV in The Netherlands (a joint-venture of Reimbold & Strick and Mr. Ch. Zwart) made attempts in the late 80ties to replace the $"CdS"$ yellow by zircon silicate 'doped' yellow pigments, viz. zircon-praeseodimium yellow (ZrSiPr) for application in plastics. One of the problems was that the zircon silicate material made the plastic more stiff and had also other negative impacts on the chemical/physical properties. Also the average particle size was too high and had to go down to a $D^50$ of $4 mu "m"$. In cooperation with the Technical University of Delft they tried to find ways to connect organic 'tails' to the zircon silicate material to make it fit better in the plastic materials.#footnote[Dr. Ir. K. te Nijenhuis. Interview in Pt-Aktueel, nr.46, 1989; Chemisch Weekblad, nr.47, 1989.] This method was successful and starting from 1994 no cadmium pigments were used anymore e.g. for the famous beer crates of some of the biggest breweries worldwide. Instead, one applied specially prepared and coated zircon-praeseodimium yellow stains for the yellow colour. This continued till about 2001 when other organic green and yellow phthalo pigments came on the market, replacing the zircon-praeseodimium stains for economical reasons.
