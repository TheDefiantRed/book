...
#figure(
  table(
    ...
    table.header([*Country*], [*Se metal in MTons 2003*]),
    table.hline(stroke: 0.5pt),
    [Belgium], [200],
    [Germany], [100],
    [Russia], [81],
...
Selenium dioxide ($"SeO"_2$) is by far the most important oxide of selenium. It is soluble in water and forms seleneous acid $"H"_2"SeO"_3$. By oxidation of seleneous acid e.g. by $"HClO"_3$, selenic acid $"H"_2"SeO"_4$ arises. Salts of selenic acid like e.g. $"BaSeO"_3$, $"ZnSeO"_3$ and $"Na"_2"SeO"_3$ are used as sources of Se. Some of them are in particular of importance at the manufacturing of CdSe glazes. $"Na"_2"SeO"_3$ has the disadvantage that it is highly hygroscopic.
