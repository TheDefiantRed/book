...
#recipe[
  ...
  #figure(
    table(
      ...
      [$"Li"_2"O", "Na"_2"O", "K"_2"O"$], [0.00 -- 0.15], [], [$"Al"_2"O"_3$], [0.08 -- 0.35], [], [$"SiO"_2$], [0.80 -- 2.10],
      [$"BaO"$], [0.35 -- 0.50], [], [], [], [], [], [],
      [$"PbO"$], [0.00 -- 0.10], [], [], [], [], [], [],
      [$"ZnO"$], [0.40 -- 0.50], [], [], [], [], [], [],
    )
...
#recipe[
  ...
  - too high an amount of $"Li"_2"O"$ turns the colour to blue
  - a certain amount of BaO and ZnO must be present for a red-violet colour
  - the $"Al"_2"O"_3$ content is not that important for the red-violet colour but more for the reactivity of the glaze
  - too much CaO turns the colour into violet-blue
  - (too much) PbO turns the colour into brownish
  - also a too high amount of NiO makes the glaze too refractory and too brownish
]
...
#recipe[
  ...
  #figure(
    table(
      ...
      [(Ferro) frit 32570], [36.00 %], [(BaO frit)],
      [(Ferro) frit 35200], [54.50 %], [(Pb0 -- ZnO frit)],
      [Kaolin], [8.00 %], [],
      [Nickel oxide], [1.50 %], [],
