...
Although the official discovery of the element took place on the eve of imposing developments in both physics and chemistry, one had already found some pieces of yellow coloured glass containing about 1% of uranium near Naples. These pieces could be dated as from AD 79.@lit:crc-handbook-of
...
Maria Curie Sklodowska continued in this field and discovered that uranium was not the only element showing radiation properties. Together with her husband and well known French physicist Pierre Curie she established that the radiation was not an exclusive property of uranium and that also thorium showed this radiation. During further investigations of minerals they found that pitchblende showed a much stronger radiation than the quantities of uranium or thorium did presume. This led to the discovery of polonium and finally to radium in 1898.@lit:eve-curie-madame

The importance of these new materials was soon distinguished. The main mineral and source for uranium was and still is pitchblende, also called uranite: #ch("U3O8"). Uranium occurs however also in much other minerals such like carnotite (an uranium potassium vanadate), in autunite (a calcium uranyl-phosphate), in uranophane (a hydrated uranium calcium silicate), in curite (a hydrated lead urinate), in torbernite (a hydrated copper uranyl phosphate and many others.@lit:a-esme-natural

Intensive searching programmes showed that the element is not as rare as it was once thought. Because of its importance in the field of the atomic energy one has searched very intensively to uranium containing minerals. Some main and well known uranium deposits are at Sjinkolobwe (Zaire), Jáchymov (Czech Rep.), Cornwall (England), Colorado (USA), near Great Bear Lake and Athabasca Lake (Canada), Witwatersrand (South Africa), Rum Jungle and Isa Mount (Australia), Bihar (India) and Poços de Caldas (Brasil).@lit:anon-uranium---

All these deposits are mainly explored with regard to the economical value of uranium. One of the most important applications is its use in electrical power plants. It may be clear that this application is out of the scope of this publication. The point however where these two items do come together again is at the developments which mention the use of a glass in a unit for the melting-in of nuclear waste material.@lit:l-d-pye@lit:wilfried-c-heimerl

Other than some early findings of uranium containing glass through which an early application is known, a deliberated use of uranium containing minerals was uncommonly limited. The application of several uranium salts in the glass@lit:j-m-stevels and ceramic industry came slightly into fashion during the first half of the 20#super[th] century. There are however not so many publications available as far as the ceramic sphere is concerned. An article of Charles F. Binns and Frobisher Lyttle@lit:charles-f-binns published in 1920 mention some compositions for uranium red glazes. As uranium source they mentioned sodium uranate (#ch("Na2U2O7")). The glazes, with 20 and 37 % #ch("Na2U2O7") resp., developed a bright cinnabar red at a temperature of SK 04a (1020 °C). The base glaze was a lead alumina silicate with only an introduction of some potassium and zinc oxide in the #ch("R2O") \/ #ch("RO") group.

#recipe[
  Another article was published by Zimmermann@lit:zimmermann-klei-no20. He started with a simple lead-alumina-silicate with the following composition:
...
Another interesting but also rather compendious article was published in 1934 by Karl Kautz@lit:karl-kautz-the. He used #ch("Na2O * 2UO3 * 6H2O") as colorant and studied the influence of glaze components on the development of specific colours. As a result he mentioned for a variety of colours the best possible glaze compositions.
