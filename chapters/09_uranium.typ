...
One of the most comprehensive and detailed studies was published in 1933 by Hans Eska#super[@lit:hans-eska-wetterfeste]. In this publication called '#text(lang: "de")[Wetterfeste uranrote Glasuren]' ('Weather resistant uranium red glazes') he described the best possible glaze compositions to obtain resistant red uranium glazes. He mentioned the application of uranium nitrate, as soluble salt, very injudicious. He also turned down the argument that this particular uranium source should be cheaper. In his investigation he indicated the influences of modifications in the #ch("R2O") \/ #ch("RO"), #ch("R2O3") and #ch("RO2") groups on the colour, gloss, craze resistance and weather resistance.
