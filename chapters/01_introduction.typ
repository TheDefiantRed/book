...
The typical colour characteristics of the CdSe glazes as shown in the Tables I and II are clearer if they are compared with the results of the colour measurements of some other typical representatives of components which also create reddish colours in ceramics. For these colour measurements the same Zeiss RFC 16 colorimeter was used. The results are given in Table III.
...
The use of Se in glass compositions is known for a long time already. The investigations of Rooksby resulting in the determination that the red colour is caused by mixed crystals of CdS.CdSe and published in 1932 were an incitement for a more intensive and scientific approach of this colour mechanism. The first application of CdSSe pigments were, besides the glass colouring, as decoration colours to be fired at rather low temperatures in a 3rd firing process. The majority of the CdSSe stains were applied in plastics and only a very small amount found an application in ceramics. Technical improvements made the pigments suitable for higher temperatures when used in specific base glazes. The use in enamel processing and low firing glazes became possible. These classic types of CdSSe pigments could be applied till about 1020 °C in a firing cycle of approximately 16 hours.

The type of glaze to be used for these CdSSe pigments was preferably a cadmium stabilized one. Several of these types of glazes are mentioned in the literature and developed by the ceramic industry.

Another significant step in the development of these colours is the invention of the so-called encapsulated pigments. The first patent is filed in 1973 and published in 1974. The nature of this type differs from the classic type. The real bright red colour tones are however difficult to achieve with the first generation of inclusion pigments. It is a kind of contradiction: the ZrSiO~4~ crystals are necessary to protect the pigment but are also the reason that a too high degree of covering power (whiteness) is formed caused by the difference in refraction index between the amorphous glass and the ZrSiO~4~ crystals.

Later developments in this sphere by the British Ceramic Research Association have shown to be an improvement of this ZrSiO~4~ protected pigment type. Colour stains made according to this patent show a real bright red colour. This improvement is realized by a modified production process resulting in the fact that all the single zircon silicate crystals contain some of the CdSSe pigment. These types of encapsulated pigments contain therefore about 7 times as much cadmium as the first inclusion pigments. This gives the pigment more firing stability while also the release of cadmium is considerably lower than its predecessor.
