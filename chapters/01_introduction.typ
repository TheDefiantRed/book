...
Red was for sure one of the first applied colours, if not the very first. The abundant use of red ochre together with yellow ochre and black for the famous prehistoric cave paintings like those of Lascaux and Altamira are in evidence of this. The red colour was often associated with blood and, more particularly, with the life-giving idea of it. This can be illustrated by the linguistic reduction of the words blood and red.#super[@lit:methuen-1978] In Sanskrit, the oldest Indo-European language, the word for blood is #text(lang: "sa")[_rudhira_]. The first part of this word appears also in other languages like e.g. Greek and Latin: #text(lang: "el")[_erythros_] and #text(lang: "la")[_rutilus_] resp. for red. Also in modern languages this word shows up like in the German '#text(lang: "de")[Rot]', the Dutch '#text(lang: "nl")[rood]', the English 'red' and the French '#text(lang: "fr")[rouge]'.

From the earliest times humankind has attached strong attributes to this colour. The main attributes meant here have to do with activity, action, struggle and other strong emotions which can all be associated with this never-tranquil character. An example illustrating the power of red is the almost innumerable number of red flags. The so-called '#text(lang: "fr")[Oriflamme]' of Charles the Great, used on the battle fields is a well-known example. Another outstanding example of the image of the red colour is the use of the red flag whenever there is a struggle or a revolution, especially when it is said to be a socialistic one. Even the red colour of the cap of Little Red Riding-Hood is in this respect not accidental, but a very conscious choice according to the explanation of psycho-analysts (Fromm), psychologists (Bettelheim) and exegetes (Hans Ritz).
...
The typical colour characteristics of the #ch("CdSe") glazes as shown in the Tables @tab:colour-measurement-zeiss[] and @tab:colour-measurement-hunterlab[] are clearer if they are compared with the results of the colour measurements of some other typical representatives of components which also create reddish colours in ceramics. For these colour measurements the same Zeiss RFC 16 colorimeter was used. The results are given in @tab:colour-measurement-comparison.
...
#figure(
  table(
    ...
    [#ch("Ni") red],           [0.437], [0.330], [594.0], [30.00], [12.04],
...
#figure(
  table(
    ...
    [#ch("Ni") red],           [B0457\*\*],                            [1020 °C / 12 hrs c.t.c.],
    [#ch("Cr") red],           [12.55097.00\*\*],                      [940 °C / 12 hrs],
    table.hline(stroke: 0.5pt),
...
From the other possibilities which can be used to create reddish colours like iron, copper, nickel, gold, #ch("CrSn") stains and sodium uranate, it can be mentioned that they all create a colour which is typical for that particular component. In most cases, the glaze requires a composition to such a degree that indeed a reddish colour is obtained but that the nature of the glaze is an absolute disadvantage in respect of industrial application. Only the use of calcined stains of the #ch("CrSn") type is quite often applied.

The use of #ch("Se") in glass compositions is known for a long time already. The investigations of Rooksby resulting in the determination that the red colour is caused by mixed crystals of #ch("CdS * CdSe") and published in 1932 were an incitement for a more intensive and scientific approach of this colour mechanism. The first application of #ch("CdSSe") pigments were, besides the glass colouring, as decoration colours to be fired at rather low temperatures in a 3rd firing process. The majority of the #ch("CdSSe") stains were applied in plastics and only a very small amount found an application in ceramics. Technical improvements made the pigments suitable for higher temperatures when used in specific base glazes. The use in enamel processing and low firing glazes became possible. These classic types of #ch("CdSSe") pigments could be applied till about 1020 °C in a firing cycle of approximately 16 hours.

The type of glaze to be used for these #ch("CdSSe") pigments was preferably a cadmium stabilized one. Several of these types of glazes are mentioned in the literature#super[@lit:eppler-1981] and developed by the ceramic industry.

Another significant step in the development of these colours is the invention of the so-called encapsulated pigments. The first patent is filed in 1973 and published in 1974#super[@lit:us-patent-3802900]. The nature of this type differs from the classic type. The real bright red colour tones are however difficult to achieve with the first generation of inclusion pigments. It is a kind of contradiction: the #ch("ZrSiO4") crystals are necessary to protect the pigment but are also the reason that a too high degree of covering power (whiteness) is formed caused by the difference in refraction index between the amorphous glass and the #ch("ZrSiO4") crystals.

Later developments in this sphere by the British Ceramic Research Association have shown to be an improvement of this #ch("ZrSiO4") protected pigment type. Colour stains made according to this patent show a real bright red colour. This improvement is realized by a modified production process resulting in the fact that all the single zircon silicate crystals contain some of the #ch("CdSSe") pigment. These types of encapsulated pigments contain therefore about 7 times as much cadmium as the first inclusion pigments#super[@lit:cubbon-1983]. This gives the pigment more firing stability while also the release of cadmium is considerably lower than its predecessor#super[@lit:uk-patent-2106530a].

After 2000 another generation of stabilized #ch("CdSSe") pigments has been developed in China. These pigments have a higher colour strength and brightness and can be applied even over 1200 °C. It is remarkable that the development of the inclusion pigments somehow stopped in the western European countries and that a new generation of much stronger and brighter pigments has been developed in China. It is generally believed that a well known supplier of inclusion pigments as e.g. the German company Broll Buntpigmente found the investments necessary to develop this new generation of very strong stains to be too high. It is not exactly known by the writer why the Peoples Rep. of China came up with these very strong stains, but it is assumed that severe laws and regulations in the western countries are very much an obstacle for the production in the western countries and that the production of these type of stains at manufacturers at e.g. China is only possible by the lack of the same severe laws and regulations regarding the working with and the production of cadmium-containing compounds.

The method of melted-in #ch("CdSe") coloured glazes came to a real industrial use during the late fifties and the sixties of the former century. Through the years, an unremitting zeal has ensured that nowadays for practically each and every firing cycle a variety of #ch("CdSe") glazes is available. Due to its better firing stability this type of #ch("CdSe") glaze has taken over the role of the classic pigmented #ch("CdSe") glazes. The conventional pigmented type of glaze has some disadvantages: the firing temperature is limited, the colour stability is less compared to the melted-in types and the glaze is sensitive for a less favourable kiln condition. These were reasons that the improved melted-in type of #ch("CdSe") glazes replaced the pigmented types for industrial applications.

Only with the latest generation of very strong and bright #ch("CdSe") pigments have the earlier disadvantages been overcome. The high prices of these strong pigments are however a block for a comprehensive application.

In the dinnerware industry another advantage benefitted the melted-in types: the lower figures for metal release and far within the limits as prescribed by the standard DIN EN 1388-1/-2. As a typical representative company which produces safe dinnerware using #ch("CdSe") glazes of the melted-in type counts e.g. the German company Wächtersbach now called Keramische Fertigungstaette Brachtal GmbH. This company has produced red glazed dinnerware for several decades already and it is e.g. meeting the requirements for export to the U.S. Only in those cases where an absolute lacquer-like appearance is required do the pigmented types fulfill these requirements better than the melted-in types. In this respect one can e.g. refer to the Fiesta dinnerware type called 'Scarlet' made in 2004 by Homer Laughlin (USA) which is produced with a suitable transparent glaze and a strong #ch("CdSSe") pigment from the last generation.

The wall- and floor tile industry used to only apply the melted-in types of glazes. Nowadays, with the strong #ch("CdSe") pigments available, these pigments are applied as well to achieve lacquer-like red colours. In particular, floor tile glazes require a special surface which can be obtained through some mill additions. The melted-in type of glazes tolerates these additions much better than the pigmented type with respect to the retention of the red colour.

It may also be stated that it is commonly known that the higher the firing temperature and the longer the firing cycle, the more difficult it becomes to retain the red colour. The fact that nowadays #ch("CdSe") glazes are available for 1200 °C and over in a firing cycle of roughly 20 hrs shows how far the developments have proceeded. The trend in the ceramic industry to apply faster firing cycles is therefore less problematical with respect to stability and retention of the colouring components. However, other problems remain and therefore these types of glazes must always be treated attentively.
