...
Another significant step in the development of these colours is the invention of the so-called encapsulated pigments. The first patent is filed in 1973 and published in 1974.#footnote[US patent 3802900, A.Broll et al., Degussa, filed 1973, published 1974. 'Zirconium Ceramic Colour Bodies'.] The nature of this type differs from the classic type. The real bright red colour tones are however difficult to achieve with the first generation of inclusion pigments. It is a kind of contradiction: the ZrSiO~4~ crystals are necessary to protect the pigment but are also the reason that a too high degree of covering power (whiteness) is formed caused by the difference in refraction index between the amorphous glass and the ZrSiO~4~ crystals.

Later developments in this sphere by the British Ceramic Research Association have shown to be an improvement of this ZrSiO~4~ protected pigment type. Colour stains made according to this patent show a real bright red colour. This improvement is realized by a modified production process resulting in the fact that all the single zircon silicate crystals contain some of the CdSSe pigment. These types of encapsulated pigments contain therefore about 7 times as much cadmium as the first inclusion pigments#footnote[R. C. P. Cubbon. 'Protected Cadmium Pigments for Ceramic Applications'. In Fact, nr. 130, June 1983]. This gives the pigment more firing stability while also the release of cadmium is considerably lower than its predecessor#footnote[UK Patent 2 106 530 A; published 1983 / BCRA (Ceram). 'Protected Pigments'.].
