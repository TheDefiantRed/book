...
The type of glaze to be used for these #ch("CdSSe") pigments was preferably a cadmium stabilized one. Several of these types of glazes are mentioned in the literature@lit:eppler-1981 and developed by the ceramic industry.

Another significant step in the development of these colours is the invention of the so-called encapsulated pigments. The first patent is filed in 1973 and published in 1974@lit:us-patent-3802900. The nature of this type differs from the classic type. The real bright red colour tones are however difficult to achieve with the first generation of inclusion pigments. It is a kind of contradiction: the #ch("ZrSiO4") crystals are necessary to protect the pigment but are also the reason that a too high degree of covering power (whiteness) is formed caused by the difference in refraction index between the amorphous glass and the #ch("ZrSiO4") crystals.

Later developments in this sphere by the British Ceramic Research Association have shown to be an improvement of this #ch("ZrSiO4") protected pigment type. Colour stains made according to this patent show a real bright red colour. This improvement is realized by a modified production process resulting in the fact that all the single zircon silicate crystals contain some of the #ch("CdSSe") pigment. These types of encapsulated pigments contain therefore about 7 times as much cadmium as the first inclusion pigments@lit:cubbon-1983. This gives the pigment more firing stability while also the release of cadmium is considerably lower than its predecessor@lit:uk-patent-2106530a.
